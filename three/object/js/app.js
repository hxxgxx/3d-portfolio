...
function init() {
    ...
    let geomat2 = new THREE.IcosahedronGeometry(15, 4);
    ...
    innerPlanet.scale.x = innerPlanet.scale.y = innerPlanet.scale.z = 10;
    circle.add(innerPlanet);

    // outter planet
    let outterPlanet = new THREE.Mesh(geomat2, mat);
    ...
    dLight[1] = new THREE.DirectionalLight(0x2BAE66, 1);
    dLight[1].position.set(0.75, 1, 0.5);
    dLight[2] = new THREE.DirectionalLight(0xEE4E34, 1);
